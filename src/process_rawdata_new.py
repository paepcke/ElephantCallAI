...
if __name__ == '__main__':
    ...
    if args.full_24_hr:
        ...
        def wrapper_processFull24Hours(directory, data_pair):
            ...
            full_24_hr_spectogram = generate_spectograms.generate_whole_spectogram(curren_dir + '/' + audio_file, spectrogram_info, -1)
            labels = generate_spectograms.generate_labels(label_path, spectrogram_info, full_24_hr_spectogram.shape[0])
